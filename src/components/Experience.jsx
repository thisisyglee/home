...
export const Experience = () => {
    ...
    useFrame((_state, delta) => {
      ...
      const scrollOffset = Math.max(0, scroll.offset) //avoid having negative value 
      ...
      tl.current.seek(lerpedScrollOffset * tl.current.duration());
        ...
        // Follow the curve points lerp = changing values over a period of time lynearly 
        ...
        <group ref={cameraGroup}>
            ...
            <group ref={airplane}>
              <Float floatIntensity={1} speed={1.5} rotationIntensity={0.5}>
                  ...
                  {/* <Paperplane rotation-y={Math.PI / 2} scale={[0.01, 0.01, 0.01]} position-y={0.1}/> */}
              </Float>
            </group>
        </group>
