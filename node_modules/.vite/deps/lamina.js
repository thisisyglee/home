import {
  ...
  useDrag
} from "./chunk-NYUTKHP2.js";
import {
  require_client,
  require_react_dom
} from "./chunk-YPPTDAWJ.js";
import {
  _extends,
  create,
  extend
} from "./chunk-62YRRXIW.js";
import {
  Color,
  Material,
  MathUtils,
    ...
    function getTokenDepth(tokens) {
      ...
      for (var i4 = 0; i4 < tokens.length; i4++) {
        ...
        if (token.type !== "ident" && token.type !== "keyword")
          continue;
        skipArrayArguments();
        if (tokens[index2].type !== "ident")
          continue;
        skipArrayArguments();
        index2++;
        if (tokens[index2].data !== "(")
          continue;
        while (tokens[index2] && tokens[index2].data !== ";" && tokens[index2].data !== "{") {
          tokens[index2++].depth++;
        }
        if (tokens[index2] && tokens[index2].data === "{")
          tokens[index2].depth++;
      }
      return tokens;
      function skipArrayArguments() {
        while (tokens[index2] && (tokens[index2].type === "whitespace" || tokens[index2].data === "[" || tokens[index2].data === "]" || tokens[index2].data === "integer"))
          index2++;
      }
    }
  }
...
`;
  ...
  getShaderFromIndex(tokens, index2) {
    return (0, import_glsl_token_string.default)(tokens.slice(index2[0], index2[1]));
  }
};
...
function isContainingBlock(element) {
  ...
  return css2.transform !== "none" || css2.perspective !== "none" || !safari && (css2.backdropFilter ? css2.backdropFilter !== "none" : false) || !safari && (css2.filter ? css2.filter !== "none" : false) || ["transform", "perspective", "filter"].some((value) => (css2.willChange || "").includes(value)) || ["paint", "layout", "strict", "content"].some((value) => (css2.contain || "").includes(value));
}
function isSafari() {
...
function getScale(element) {
  ...
  let y4 = (fallback ? round(rect.height) : rect.height) / height;
...
function getDocumentRect(element) {
  ...
  if (getComputedStyle$1(body).direction === "rtl") {
    x3 += max2(html.clientWidth, body.clientWidth) - width;
  }
  return {
    width,
    height,
...
function ColorComponent() {
  ...
  return import_react24.default.createElement(Row, {
    input: true
  }, import_react24.default.createElement(Label, null, label), import_react24.default.createElement(PickerContainer, null, import_react24.default.createElement(Color2, {
    value,
    displayValue,
    onChange,
    onUpdate,
...
var Abstract = class {
  ...
  buildShaders(constructor) {
    ...
    this.schema = this.schema.filter((value, index2) => {
      const _value = value.label;
      return index2 === this.schema.findIndex((obj) => {
  ...
  getShaderFromIndex(tokens, index2) {
    return (0, import_glsl_token_string2.default)(tokens.slice(index2[0], index2[1]));
  }
  getBlendMode(b4, a4) {
    switch (this.mode) {
      default:
...
var DebugLayerMaterial = import_react27.default.forwardRef(({
  children,
  ...props3
}, forwardRef3) => {
  var _ref$current, _ref$current2, _ref$current3;
  const ref = import_react27.default.useRef(null);
  (0, import_react27.useImperativeHandle)(forwardRef3, () => ref.current);
  const store = useCreateStore();
  const [layers, setLayers] = import_react27.default.useState({});
  const [path, setPath] = import_react27.default.useState(["", ""]);
  const textureLoader = (0, import_react27.useMemo)(() => new TextureLoader(), []);
  useControls({
    "Copy JSX": button(() => {
  ...
  const [args, otherProps] = (0, import_react27.useMemo)(() => getLayerMaterialArgs({
    ...props3,
    lighting: Lighting
  }), [props3, Lighting]);
  ...
  import_react27.default.useEffect(() => {
    ...
    if (updatedData) {
      ...
      const index2 = parseInt(split2[0].split(" ~")[1]);
      const property = path[1];
      const id = ref.current.layers[index2].uuid;
      const uniform = ref.current.uniforms[`u_${id}_${property}`];
      const layer = ref.current.layers[index2];
      if (property !== "map") {
  ...
  import_react27.default.useLayoutEffect(() => {
    ...
    if (root) {
      ...
      levaRoot.render(import_react27.default.createElement(LevaPanel, {
        titleBar: {
  ...
  return import_react27.default.createElement(import_react27.default.Fragment, null, Object.entries(layers).map(([name, layers2], i4) => import_react27.default.createElement(DynamicLeva, {
    key: `${name} ~${i4}`,
    name,
    layers: layers2,
    store,
    setUpdate: setPath
  })), import_react27.default.createElement("layerMaterial", _extends({
    args: [args],
    ref
  }, otherProps), children));
});
...
var LayerMaterial = import_react27.default.forwardRef(({
  children,
  ...props3
}, forwardRef3) => {
  const ref = import_react27.default.useRef(null);
  ...
  const [args, otherProps] = (0, import_react27.useMemo)(() => getLayerMaterialArgs(props3), [props3]);
  return import_react27.default.createElement("layerMaterial", _extends({
    args: [args],
    ref
  }, otherProps), children);
});
...
var Depth = import_react27.default.forwardRef((props3, forwardRef3) => {
  return import_react27.default.createElement("depth_", _extends({
    args: getNonUniformArgs(props3),
    ref: forwardRef3
  }, props3));
});
var Color3 = import_react27.default.forwardRef((props3, ref) => {
  return import_react27.default.createElement("color_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Noise = import_react27.default.forwardRef((props3, ref) => {
  return import_react27.default.createElement("noise_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Fresnel = import_react27.default.forwardRef((props3, ref) => {
  return import_react27.default.createElement("fresnel_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Gradient = import_react27.default.forwardRef((props3, ref) => {
  return import_react27.default.createElement("gradient_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Matcap = import_react27.default.forwardRef((props3, ref) => {
  return import_react27.default.createElement("matcap_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Texture2 = import_react27.default.forwardRef((props3, ref) => {
  return import_react27.default.createElement("texture_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Displace = import_react27.default.forwardRef((props3, ref) => {
  return import_react27.default.createElement("displace_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Normal = import_react27.default.forwardRef((props3, ref) => {
  return import_react27.default.createElement("normal_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
