        ...
        if (group.current && instance.current && composer) {
          ...
          for (let i2 = 0; i2 < children2.length; i2++) {
            ...
            if (child instanceof postprocessing.Effect) {
              const effects = [];
              while (children2[i2] instanceof postprocessing.Effect)
...
const Autofocus = React.forwardRef(
  ({ target = void 0, mouse: followMouse = false, debug = void 0, manual = false, smoothTime = 0.25, ...props }, fref) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(DepthOfField, { ref: dofRef, ...props, target: hitpoint })
    ] });
  }
);
...
const $e4ca8dcb0218f846$var$_geometry = new THREE.BufferGeometry();
$e4ca8dcb0218f846$var$_geometry.setAttribute("position", new THREE.BufferAttribute(new Float32Array([
  -1,
  -1,
  3,
  -1,
...
$e4ca8dcb0218f846$var$_geometry.setAttribute("uv", new THREE.BufferAttribute(new Float32Array([
  0,
  0,
  2,
  0,
...
$e4ca8dcb0218f846$var$_geometry.boundingSphere = new THREE.Sphere();
$e4ca8dcb0218f846$var$_geometry.computeBoundingSphere = function() {
};
const $e4ca8dcb0218f846$var$_camera = new THREE.OrthographicCamera();
class $e4ca8dcb0218f846$export$dcd670d73db751f5 {
  constructor(material) {
    this._mesh = new THREE.Mesh($e4ca8dcb0218f846$var$_geometry, material);
...
class $87431ee93b037844$export$2489f9981ab0fa82 extends postprocessing.Pass {
  /**
   * 
  ...
  constructor(scene, camera, width = 512, height = 512) {
    ...
    this.configureHalfResTargets();
    this.copyQuad = new $e4ca8dcb0218f846$export$dcd670d73db751f5(new THREE.ShaderMaterial({
      uniforms: {
        tDiffuse: {
          value: null
        }
  ...
  configureHalfResTargets() {
    if (this.configuration.halfRes) {
      ...
      this.depthDownsampleQuad = new $e4ca8dcb0218f846$export$dcd670d73db751f5(new THREE.ShaderMaterial($26aca173e0984d99$export$1efdf491687cd442));
    } else {
  ...
  configureAOPass(logarithmicDepthBuffer = false) {
    ...
    if (this.effectShaderQuad) {
      ...
      this.effectShaderQuad = new $e4ca8dcb0218f846$export$dcd670d73db751f5(new THREE.ShaderMaterial(e));
  }
  configureDenoisePass(logarithmicDepthBuffer = false) {
    ...
    if (this.poissonBlurQuad) {
      ...
      this.poissonBlurQuad = new $e4ca8dcb0218f846$export$dcd670d73db751f5(new THREE.ShaderMaterial(p));
  }
  configureEffectCompositer(logarithmicDepthBuffer = false) {
    ...
    if (this.effectCompositerQuad) {
      ...
      this.effectCompositerQuad = new $e4ca8dcb0218f846$export$dcd670d73db751f5(new THREE.ShaderMaterial(e));
  }
  /**
       * 
       * @param {Number} n 
